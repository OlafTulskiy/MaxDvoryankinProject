...
public class AppGame {
    ...
    public static String playerName = "Sir Gawain";
    ...
    public static void spawnCoins() {//add method for add coins - copy past of method 'spawnEnemies'
        int countCoins = (mapWidth + mapHeight) / 3;
        int coinsPosX;
        int coinsPosY;
        for (int i = 1; i <= countCoins; i++) {
            ...
            map[coinsPosY][coinsPosX] = coinCell;
        }
    }
    ...
    public static void playerNextCellAction() {
        if (map[playerPosY][playerPosX] == enemy) {
            ...
            enemiesCount--;
            playerExp += 250;
            System.out.println("Enemy attack hero by attack power - " + enemyPower + ".");
            System.out.println("Hero health is - " + playerHealth);
            System.out.println("Hero attack enemy by power - " + enemyHealth);
